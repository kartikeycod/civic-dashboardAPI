  ...
  try {
    ...
    data.forEach(r => {
      if (r.latitude && r.longitude) {
        ...
        if (r.image_url) popup += `<br><img src="${r.image_url}" style="max-width:180px;max-height:150px;margin-top:6px;border-radius:8px;box-shadow:0 0 8px #8629b395;" />`;
...
document.getElementById('submitBtn').addEventListener('click', async () => {
  ...
  if (image_url) {
    statusDiv.innerHTML += `<div style="margin-top:8px;"><img src="${image_url}" alt="Uploaded" style="max-width:180px;max-height:120px;border-radius:7px;box-shadow:0 0 8px #7334e944"/></div>`;
  }
